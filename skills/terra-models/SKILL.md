...
| ---------------- | --------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------ |
| `sleep_window`   | A recommended bedtime, wake time and in-bed duration, a 0–100 consistency score with a band, and the single change that would most improve it | Overnight sleep sessions from the last few weeks |
