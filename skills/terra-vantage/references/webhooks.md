...
`data`: `order_id`, `order_item_id`, `variant_id` (strings), `results_status`, and a `test_taker` object (`test_taker_id` string, `first_name`, `last_name`, `email`, `phone_number` E.164 string). Status-dependent extras below.
